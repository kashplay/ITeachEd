...
export function PreEvaluationPage() {
  ...
  const handlePrevious = () => {
    if (currentStep > 0) {
      ...
      // FIXED: Pass state to indicate user came from pre-evaluation via back button
      console.log('🔄 PreEvaluation: Back button clicked on first question, redirecting to landing page with state')
      navigate('/', { 
        replace: true, 
